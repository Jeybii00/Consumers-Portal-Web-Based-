...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               <p>old password</p>
               <input type="password" name="password" placeholder="enter your old password" maxlength="50" class="box">
               <p>new password</p>
               <input type="password" name="new_password" placeholder="enter your new password" maxlength="50" class="box">
               <p>confirm password</p>
               <input type="password" name="cpassword" placeholder="confirm your new password" maxlength="50" class="box">
         </div>
      </div>
