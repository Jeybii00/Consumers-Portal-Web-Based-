...
<head>
    ...
    <title>Manage Reconnection Forms</title>
...
<body>
    <div class="user-container my-5">
        <h2 style="text-align:center; font-weight:bold; font-size:30px;">Reconnection With Change Name Forms</h2>
        ...
        <table class="table table-bordered table-hover table-sm">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM reconnection_form";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary btn-sm"
                                href="reconnection_update.php?id=<?php echo $row['id']; ?>">View </a>
                        </td>
