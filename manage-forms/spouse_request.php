...
<head>
    ...
    <title>Manage Change Name Spouse Forms</title>
    <style>
        table,
        th,
        td {
...
<body>
    <div class="user-container my-5">
        <h2 style="text-align:center; font-size:30px; font-weight:bold;">Manage Consumer's Spouse Forms</h2>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="spouse-update.php?id=<?php echo $row['id']; ?>">View</a>
                        </td>
